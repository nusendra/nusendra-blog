...
@section('title','Nusendra.com - Payroll & Man Power')
@section('description',"Nusendra's Portfolio - Payroll & Man Power'")
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="site-heading">
          <h1>PAYROLL & MAN POWER</h1>
          <p>
            <span class="subheading">Web Aplikasi yang berfungsi untuk mencatat absensi para pekerja lapangan dan membuat laporan salary untuk PT. Ume Persada Indonesia</span>
          </p>
        </div>
      </div>
    </div>
		...
		<div class="row">
			<div class="col-lg-8 col-md-10 mx-auto">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>Tech Stack</td>
                        <td>PHP (Lumen Framework), JavaScript (Nuxt.js)</td>
                    </tr>
                </table>
                <p>
                ...
                <p>
                    Masih manual nya kontraktor di PT. Benteng Api  Technic dalam mencatat absensi dan menentukan salary bagi para pekerja borongan nya akan berimbas pada tidak efisien nya cara kerja dan pencatatan nya, problem ini baru terasa ketika man power yang di handle mencapai ratusan. Dengan latar belakang inilah dibuatnya aplikasi ini. Selain itu juga memudahkan untuk membuat laporan absensi dan salary yang nanti nya akan diteruskan ke pihak PT. UPI
                </p>
                <p>
                    <h3>Tech Detail</h3>
                </p>
                ...
                <p>
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="row">
                                <a href="https://farm5.staticflickr.com/4830/32296128608_b9169ed3be_z.jpg" data-toggle="lightbox" data-gallery="gallery" class="col-sm-3">
                                    <img src="https://farm5.staticflickr.com/4830/32296128608_b9169ed3be_q.jpg" class="img-fluid" alt="nusendra-pwa-splash">
                                </a>
